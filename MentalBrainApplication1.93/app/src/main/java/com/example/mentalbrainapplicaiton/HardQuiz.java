...
public class HardQuiz extends AppCompatActivity {
    private HardQuestions newHardQuestions = new HardQuestions();
    ...
    private void nextQuestion() {
        ...
        myQuestions.setText(newHardQuestions.getQuestion(QuestionNumber));
        newAnswer = newHardQuestions.getAnswers(QuestionNumber);
        QuestionNumber++;
